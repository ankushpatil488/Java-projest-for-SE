...
public class BusReservation {
    ...
    int to=0,y=1,z=0,end=0,r=1,flag=0,seat;
    		...
    		for(int x=1; x==1;){
    			...
    			for(x=1; x==1;){
					...
					if (choice.equals("1")){
    					...
    					System.out.println("***************************************");
					System.out.println("*  1.)Pune           | 800 Rs |   "+available[1]+"    *");
    					System.out.println("*  2.)Mumbai         | 600 Rs |   "+available[2]+"    *");
    					System.out.println("*  3.)Aurangabad     | 400 Rs |   "+available[3]+"    *");
    					System.out.println("*  4.)Nashik         | 300 Rs |   "+available[4]+"    *");
    					System.out.println("*  5.)Nagpur         | 900 Rs |   "+available[5]+"    *");
    					System.out.println("***************************************");
						System.out.println("***************************************\n");
					...
					//if CHOICE is "2" proceed to Ticket Booking//
    					...
    					String dest[] = { " ", "Pune", "Mumbai", "Aurangabad", "Nashik", "Nagpur"};
    					double fare[] = { 0,800,600,400,300,900};
    					...
    					for(x=1;x==1;){
    						...
    						x=1;
    		                    ...
    		                    if(flag==1)
    		                        seat=20-(available[to]+ticketI[z][0]);
                                    else
                                         seat=20-available[to];
                                    int j=0;
                                    int n=ticketI[z][0];
                                    int[] your=new int [n];
                                    while(j<n)
